...
-- 1  create database  soal_tes_flip
CREATE DATABASE IF NOT EXISTS `soal_tes_flip` ;
USE `soal_tes_flip`;

-- 2 create table soal_tes_flip.disburs
...
-- 3 insert data soal_tes_flip.disburs
INSERT INTO `disburs` (`id`, `time_served`, `id_disburs`, `receipt`, `status_disburs`, `response`, `request`, `api`, `created_at`, `updated_at`) VALUES
